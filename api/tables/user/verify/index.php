...
$result = Database::execute("select player, CREATION_TIME from EMAIL_VERIFICATION where VERIFICATION_ID = :id", array(":id" => $_GET["verification_id"]));
...
if ($minutes_since_creation_time > 60) {
	...
	Database::execute('update player set VERIFIED = 1 where ID = 1');
